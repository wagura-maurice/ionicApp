...
$config["abs_url_images"] 		= "http://127.0.0.1/ionic/api//media/image/" ; 		//Absolute Images URL
$config["abs_url_videos"] 		= "http://127.0.0.1/ionic/api//media/media/" ; 		//Absolute Videos URL
$config["abs_url_audios"] 		= "http://127.0.0.1/ionic/api//media/media/" ; 		//Absolute Audio URL
$config["abs_url_files"] 		= "http://127.0.0.1/ionic/api//media/file/" ; 		//Absolute Files URL
...
switch($_GET["json"]){	
	...
	case "route":		$rest_api=array();
		$rest_api["site"]["name"] = "demo" ;
		$rest_api["site"]["description"] = "Nulla quis lorem ut libero malesuada feugiat. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Vestibulum ac diam sit amet quam vehicula elementum sed sit amet dui. Nulla porttitor accumsan tincidunt. Curabitur aliquet quam id dui posuere blandit. Cras ultricies ligula sed magna dictum porta. Curabitur aliquet quam id dui posuere blandit. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Donec rutrum congue leo eget malesuada. Nulla quis lorem ut libero malesuada feugiat." ;
