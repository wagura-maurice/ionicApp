 ...
 * @author Wagura Maurice <wagura465@gmail.com>
 * @copyright mhub 2018
 * @package demo
 * 
 * 
...
$config["pass"]			= "toor" ; 		//Password SQL
$config["dbase"]			= "db_demo" ; 		//Database
/** admin **/
...
if($_SESSION["IS_ADMIN"]==true){
	...
	$tags_html .= "</ul>" ;
	$tags_html .= "<h1 class=\"text-muted\">demo</h1>" ;
	$tags_html .= "<p>Nulla quis lorem ut libero malesuada feugiat. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Vestibulum ac diam sit amet quam vehicula elementum sed sit amet dui. Nulla porttitor accumsan tincidunt. Curabitur aliquet quam id dui posuere blandit. Cras ultricies ligula sed magna dictum porta. Curabitur aliquet quam id dui posuere blandit. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Donec rutrum congue leo eget malesuada. Nulla quis lorem ut libero malesuada feugiat.</p>" ;
	$tags_html .= "</div>" ;
	$tags_html .= "</div>" ;
	$tags_html .= "<div class=\"container-fluid\">" ;
	...
	switch($_GET["table"]){
		case "home":
					$tags_html .= "<h4 class=\"page-title\">demo</h4>" ;
					$tags_html .= "<div class=\"row\">" ;
...
<div class="form-group">
	...
	<input id="date" class="form-control" data-type="text" type="text" name="date" placeholder="" />
...
<div class="form-group">
	...
	<input id="service" class="form-control" data-type="heading-1" type="text" name="service" placeholder="" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	...
	<input id="uname" class="form-control" data-type="as_username" type="text" name="uname" placeholder="" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	...
	<input id="status" class="form-control" data-type="text" type="text" name="status" placeholder="" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	...
	<textarea id="note" class="form-control"  data-type="to_trusted" name="note" ></textarea>
	<p class="help-block"></p>
</div>
					<div class="form-group">
						<label for="add"></label>
...
<div class="form-group">
	<label for="date">' . @LANG_DATE. '</label>
	<input id="date" class="form-control" data-type="text" type="text" name="date" placeholder="" value="'.htmlentities($data_date).'" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	<label for="service">' . @LANG_SERVICE. '</label>
	<input id="service" class="form-control" data-type="heading-1" type="text" name="service" placeholder="" value="'.htmlentities($data_service).'" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	<label for="uname">' . @LANG_UNAME. '</label>
	<input id="uname" class="form-control" data-type="as_username" type="text" name="uname" placeholder="" value="'.htmlentities($data_uname).'" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	<label for="status">' . @LANG_STATUS. '</label>
	<input id="status" class="form-control" data-type="text" type="text" name="status" placeholder="" value="'.htmlentities($data_status).'" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	<label for="note">' . @LANG_NOTE. '</label>
	<textarea id="note" class="form-control"  data-type="to_trusted" name="note" >'.htmlentities($data_note).'</textarea>
	<p class="help-block"></p>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<input id="fullname" class="form-control" data-type="heading-1" type="text" name="fullname" placeholder="" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	...
	<input id="pwd" class="form-control" data-type="as_password" type="text" name="pwd" placeholder="" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	...
	<textarea id="address" class="form-control"  data-type="to_trusted" name="address" ></textarea>
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	...
	<input id="type_ic" class="form-control" data-type="text" type="text" name="type_ic" placeholder="" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	...
	<input id="no_ic" class="form-control" data-type="text" type="text" name="no_ic" placeholder="" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	...
	<input id="phone" class="form-control" data-type="text" type="text" name="phone" placeholder="" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	...
	<input id="email" class="form-control" data-type="text" type="text" name="email" placeholder="" />
	<p class="help-block"></p>
</div>
					<div class="form-group">
						<label for="add"></label>
...
<div class="form-group">
	<label for="fullname">' . @LANG_FULLNAME. '</label>
	<input id="fullname" class="form-control" data-type="heading-1" type="text" name="fullname" placeholder="" value="'.htmlentities($data_fullname).'" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	<label for="pwd">' . @LANG_PWD. '</label>
	<input id="pwd" class="form-control" data-type="as_password" type="text" name="pwd" placeholder="" value="'.htmlentities($data_pwd).'" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	<label for="address">' . @LANG_ADDRESS. '</label>
	<textarea id="address" class="form-control"  data-type="to_trusted" name="address" >'.htmlentities($data_address).'</textarea>
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	<label for="type_ic">' . @LANG_TYPE_IC. '</label>
	<input id="type_ic" class="form-control" data-type="text" type="text" name="type_ic" placeholder="" value="'.htmlentities($data_type_ic).'" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	<label for="no_ic">' . @LANG_NO_IC. '</label>
	<input id="no_ic" class="form-control" data-type="text" type="text" name="no_ic" placeholder="" value="'.htmlentities($data_no_ic).'" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	<label for="phone">' . @LANG_PHONE. '</label>
	<input id="phone" class="form-control" data-type="text" type="text" name="phone" placeholder="" value="'.htmlentities($data_phone).'" />
	<p class="help-block"></p>
</div>
...
<div class="form-group">
	<label for="email">' . @LANG_EMAIL. '</label>
	<input id="email" class="form-control" data-type="text" type="text" name="email" placeholder="" value="'.htmlentities($data_email).'" />
	<p class="help-block"></p>
</div>
<div class="form-group">
	<label for="edit"></label>
	<input class="btn btn-primary" type="submit" name="edit" />
		...
		$tags_html .= "<div class=\"container-fluid\">" ;
		$tags_html .= "<div class=\"row\">" ;
		$tags_html .= "<div class=\"col-md-12\"><p class=\"text-left navbar-text\">Copyright &copy; mhub 2018 - All Rights Reserved</p></div>" ;
		$tags_html .= "</div>" ;
